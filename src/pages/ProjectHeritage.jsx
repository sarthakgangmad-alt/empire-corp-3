        ...
        <div className="min-h-screen bg-stone-50 pt-20">
            ...
            <div className="relative h-[70vh] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-end pb-16 px-4 sm:px-6 lg:px-8 z-20 max-w-7xl mx-auto w-full">
                    ...
                    >
                        ...
                        <p className="text-xl text-stone-200 uppercase tracking-widest font-light">Oakville, ON</p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-20">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6">Preserving History, Enhancing Life</h2>
                ...
                >
                    <div>
                        <h3 className="text-2xl font-bold text-stone-900 mb-4">Client Goals</h3>
                ...
                <motion.section
                    ...
                    viewport={{ once: true }}
                >
                    <h3 className="text-2xl font-bold text-stone-900 mb-6">Restoration Approach</h3>
                ...
                >
                    <h3 className="text-2xl font-bold text-stone-900 mb-6">Challenges & Craftsmanship</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <h4 className="font-bold text-stone-900 mb-2">Structural Stabilization</h4>
                            <p className="text-sm text-stone-600">
                                Shored up sagging floor joists and reinforced the original stone foundation to correct decades of settling.
                            </p>
                        </div>
                        <div>
                            <h4 className="font-bold text-stone-900 mb-2">Matching Historic Trim</h4>
                            <p className="text-sm text-stone-600">
                                Our master carpenters custom-milled new baseboards and crown molding to perfectly match profiles from 1920.
                            </p>
                        </div>
                        <div>
                            <h4 className="font-bold text-stone-900 mb-2">Systems Integration</h4>
                            <p className="text-sm text-stone-600">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <PaintBucket size={48} className="mx-auto text-orange-500 mb-6" />
                        <h3 className="text-3xl font-bold mb-4">Respect for the Past. Built for the Future.</h3>
                        <p className="text-stone-400 mb-8 max-w-2xl mx-auto">
                            Trust Empire Construction Corp with your complex renovation and restoration projects.
                        </p>
