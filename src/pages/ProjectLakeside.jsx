        ...
        <div className="min-h-screen bg-stone-50 pt-20">
            ...
            <div className="relative h-[70vh] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-end pb-16 px-4 sm:px-6 lg:px-8 z-20 max-w-7xl mx-auto w-full">
                    ...
                    >
                        ...
                        <p className="text-xl text-stone-200 uppercase tracking-widest font-light">Toronto, ON</p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-20">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6">Redefining Lakeside Luxury</h2>
                ...
                >
                    <div>
                        <h3 className="text-2xl font-bold text-stone-900 mb-4">The Vision</h3>
                ...
                <motion.section
                    ...
                    viewport={{ once: true }}
                >
                    <h3 className="text-2xl font-bold text-stone-900 mb-6">Design & Engineering Approach</h3>
                ...
                >
                    <h3 className="text-2xl font-bold text-stone-900 mb-6">Overcoming Challenges</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <h4 className="font-bold text-stone-900 mb-2">Landscape Preservation</h4>
                        ...
                        <div>
                            <h4 className="font-bold text-stone-900 mb-2">Precision Glazing</h4>
                            <p className="text-sm text-stone-600">
                                Installation of 12-foot glass panels required custom crane logistics to navigate the sloping site terrain safely.
                            </p>
                        </div>
                        <div>
                            <h4 className="font-bold text-stone-900 mb-2">Structural Integration</h4>
                            <p className="text-sm text-stone-600">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <Building2 size={48} className="mx-auto text-orange-500 mb-6" />
                        <h3 className="text-3xl font-bold mb-4">Built with Precision. Delivered with Pride.</h3>
                        <p className="text-stone-400 mb-8 max-w-2xl mx-auto">
                            Empire Construction Corp brings this level of dedication and detail to every project we undertake.
                        </p>
